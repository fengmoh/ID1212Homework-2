...
public class ServerConnection implements Runnable {
    ...
    /**
     * Sends the user's username to the server. That username will be prepended
     * to all messages originating from this client, until a new username is
     * specified.
     *
    ...
    /**
     * Sends a chat entry to the server, which will broadcast it to all clients
     * including this, sending, client.
     *
